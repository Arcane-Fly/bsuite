...
/**
 * Fetches analytics data for a tenant.
 *
 * @param tenantId - The tenant to query
 * @param client   - Optional pre-built Supabase client. Pass the server client
 *                   from page.tsx to avoid importing next/headers into the browser
 *                   bundle. When omitted, a browser client is created automatically.
 */
