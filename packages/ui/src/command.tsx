...
interface CommandDialogProps extends DialogProps {
  // Accessible name for the dialog (sr-only DialogTitle). Override per-instance
  // so each palette has a distinctive name — WCAG 4.1.2 Name, Role, Value.
  title?: string
  // Accessible description (sr-only DialogDescription, announced after the title).
  description?: string
}
