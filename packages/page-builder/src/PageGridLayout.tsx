 ...
 * on top of the card heading at every breakpoint — measured on the Candidates
 * card, tenant A dark 1440 and tenant B light 390.
 *
...
function GridItemEditorChrome({
  ...
  return (
    <div
      ...
      className="flex flex-none items-center gap-1 px-2 py-1 bg-muted text-muted-foreground"
    >
      <span className="text-[10px] px-1.5 py-0.5 rounded-md font-medium">{label}</span>
      <button
        type="button"
