...
describe('resolvePlatformLogo', () => {
  ...
  it('prefers the mark for mark slots and falls back to the full logo', () => {
    expect(resolvePlatformLogo({ mark_url: 'https://cdn.example.com/mark.svg', logo_url: 'https://cdn.example.com/full.svg' }, { slot: 'mark' }).src)
      .toBe('https://cdn.example.com/mark.svg')

    expect(resolvePlatformLogo({ logo_url: 'https://cdn.example.com/full.svg' }, { slot: 'mark' }).src)
      .toBe('https://cdn.example.com/full.svg')
  })
