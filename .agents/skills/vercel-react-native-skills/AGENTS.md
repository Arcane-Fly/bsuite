...
parameter, and each (memoized) item invokes it with its own id.
...
<LinearGradient colors={['oklch(0.000 0 0)', 'oklch(1.000 0 0)']} />

// Correct – native CSS gradient syntax
<View
  style={{
    experimental_backgroundImage: 'linear-gradient(to bottom, oklch(0.000 0 0), oklch(1.000 0 0))',
  }}
/>
```
...
{ shadowColor: 'oklch(0.000 0 0)', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1 }
{ elevation: 4 }

// Correct – CSS box-shadow syntax
{ boxShadow: '0 2px 8px oklch(0.000 0 0 / 0.1)' }
```
...
<Text style={{ color: 'oklch(0.510 0 0)' }}>Subtitle</Text>
<Text style={{ color: 'oklch(0.683 0 0)' }}>Caption</Text>
```
