...
**Related:** ADR-0001 (Page-Builder Ownership); `docs/20260227-dry-one-shot-architecture-v1.01A.md` §11 Phase 5; `docs/plans/20260422-entity-linkage-schema-builder-uplift-v1.02W.md`
...
5. **DRY spec update** — `20260227-dry-one-shot-architecture-v1.01A.md` §1 row updated.
