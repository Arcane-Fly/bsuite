...
**Related:** `docs/20260227-dry-one-shot-architecture-v1.01A.md` §1 (`contacts`), §2 Flow E (Contact Reuse), §4 Auto-Population Rules; WS-E.1 Client↔Host Employer unification
...
2. **The canonical one-shot spec already documents the principle** (`docs/20260227-dry-one-shot-architecture-v1.01A.md` §2 Flow E, §3 Tier-3 `ContactCard` behaviour). This ADR makes it enforceable rather than aspirational by tying it to the WS-E.1 and WS-E.5 audits.
