...
**Related:** ADR-0001 (Page-Builder Ownership); `docs/20260227-dry-one-shot-architecture-v1.01A.md` §3 Tier-1
...
5. **Documentation:** `docs/20260227-dry-one-shot-architecture-v1.01A.md` §3 Tier-1 updated to document the canonical renderer pattern (Supabase query shape + widget catalogue contract) without prescribing shared code.
