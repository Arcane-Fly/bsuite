...
**Correction from review:** App card/section headings must NOT use pure white (`#ffffff`). Use accent-200 or `slate-200` (`#e2e8f0`) — subtle tint, not pure white. This applies to all heading text sitting on the dark navy shell.
