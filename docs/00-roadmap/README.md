...
> This directory preserves dated plans, source IDs and generated technical indexes. For current human outcome status use the [BSuite Linear project](https://linear.app/braden-pty-ltd/project/bsuite-delivery-and-roadmap-806afbd51657) and [work-tracking contract](../20260924-linear-work-tracking-v1.00W.md). Unmapped source IDs remain open migration work under [BRA-46](https://linear.app/braden-pty-ltd/issue/BRA-46/centralize-bsuite-work-in-linear-and-retire-conflicting-tracking).
