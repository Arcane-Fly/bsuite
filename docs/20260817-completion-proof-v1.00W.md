...
| **M-7** | **`award_classifications` has 0 rows.** `award_rates` cannot be seeded until it is populated. There are 156 awards loaded and no rates behind any of them. This is the standing blocker for the whole money lane. |
