...
|---|------|---------|--------|-------|--------|
| 3a | **9-wave UI uplift program** — W0 + W1 shipped 2026-05-07; W4 scoping landed (`bsuite#681`); BSU implementation PRs for W4/W6 are open (`BSU#376`, `BSU#375`) pending merge. Active queue: W2 (Reports CRM7), W3 (Pay Item Groups + 3 sibling settings), W5 (Tenant Admin), W7 (Apprentice placements). W8 (consumer bumps × 4 apps) remains blocked on W7. Ownership locked: claude-loop = W2/W4/W6, perplexity-computer = W3/W5/W7/W8. Tracker: [bsuite#635](https://github.com/GaryOcean428/bsuite/issues/635). | all | 4w | claude-loop + perplexity-computer | [INDEX.md](./plans/uplift/INDEX.md) |
