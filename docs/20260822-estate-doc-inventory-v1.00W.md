...
```
  527 doc(s); 368 gate/workflow file(s) form the evidence layer
  already marked complete in the filename        120
    ...of those, citing NO live gate             0   <-- the claim rests on nothing
  CITE a gate or workflow that EXISTS            102   <-- the only docs that can ever be marked
  cite a gate that NO LONGER EXISTS              2   <-- citing a ghost; reads as evidence
  cite nothing checkable                         425
  historical records (by path or banner)         151
  DEAD CITATIONS — a doc pointing at a gate that was deleted:
    crm7/docs/audits/20260811-ci-guards-deferred-items-v1.00F.md
        quality.yml
    crm7/docs/audits/20260811-ci-guards-that-cannot-fail-v1.00F.md
        quality.yml
  BINDABLE — these name a gate that exists, so their claim is checkable:
    docs/00-roadmap/20260112-master-roadmap-v1.00F.md
        check-doc-naming.mjs, audit-doc-completion.mjs, audit-routes.sh
    docs/00-roadmap/20260808-intake-and-onboarding-findings-v1.00W.md
        reencrypt-sensitive-documents.mjs
    docs/00-roadmap/20260809-class-a-baseline-before-the-batch-v1.00F.md
        verify-class-a-preservation.mjs
    docs/00-roadmap/20260810-r804-carryover-register-v1.00W.md
        app-quality-checks.yml, build-and-test.yml
    docs/00-roadmap/20260810-theme-ui-ux-outstanding-register-v1.00W.md
        verify-esm-imports.sh, codemod-inline-colour-styles.mjs, audit-applied-tokens.mjs, theme-gates.sh, theme-gates-browser.sh
    docs/00-roadmap/20260812-estate-remaining-work-register-v1.00F.md
        ci.yml
    docs/00-roadmap/20260812-pi-run-handback-v1.00W.md
        sync-inline-eslint-rules.mjs, ci.yml
    docs/00-roadmap/20260827-one-row-one-truth-alignment-process-v1.00W.md
        estate-align.mjs, estate-alignment.yml
    docs/00-roadmap/BSUITE-COMPONENT-REGISTRY.md
        generate-component-registry.mjs
    docs/00-roadmap/BSUITE-FEATURE-INDEX.md
        check-base-stack-only.mjs, check-script-parity.sh, audit-legibility.mjs, check-content-contrast-tier.mjs, audit-doc-completion.mjs
    docs/00-roadmap/DOD-ENFORCEMENT-PROMPT.md
        estate-align.mjs, estate-alignment.yml
    docs/00-roadmap/README.md
        generate-docs-directory-index.mjs
    docs/20260227-contributing-standards-guide-v1.01W.md
        parse-closing-keywords.mjs, guard-registry.mjs, development-merge-issue-closer.yml
    docs/20260227-dry-one-shot-architecture-v1.04A.md
        audit-one-shot.mjs, dry-lint.yml
    docs/20260506-dependency-bump-checklist-v1.00A.md
        regen-consumer-lockfile.mjs
    ...
    docs/20260731-platform-operations-reference-v1.00W.md
        check-own-package-freshness.mjs, check-shared-package-reach.mjs, check-shared-package-reach.py, regen-consumer-lockfile.mjs, shared-package-reach-lint.yml
    ...
    docs/20260817-built-unlanded-and-unwired-register-v1.00W.md
        check-hook-suppression-ratchet.mjs, audit-routes.sh, check-placement-rate-provenance.mjs, guard-registry.mjs, theme-session.sh
    docs/20260817-coverage-gap-closure-v1.00W.md
        check-colour-ban-reaches-converters.mjs, check-recovered-doc-verdicts.mjs, audit-d2c-theme.sh, check-guard-self-reporting.mjs, guard-registry.mjs
    … 77 more NOT SHOWN — re-run with --all
```
...
|---|---|---|---|
| `crm7/docs/audits/20260811-ci-guards-deferred-items-v1.00F.md` | DEAD-CITATION | yes | lint-ratchet.mjs, check-migration-fk-indexes.mjs, lint-sql-migrations.mjs |
| `crm7/docs/audits/20260811-ci-guards-that-cannot-fail-v1.00F.md` | DEAD-CITATION | yes | lint-ratchet.mjs, lint-sql-migrations.mjs, check-report-catalog-drift.mjs |
| `braden/docs/20260316-braden-qa-configuration-v1.00F.md` | BINDABLE | yes | health-check.sh |
| `braden/docs/20260723-schema-builder-registry-consolidation-chore-v1.00F.md` | BINDABLE | yes | check-own-package-freshness.mjs, check-shared-package-reach.mjs, check-zero-consumers.mjs |
| `business-suite-unified/docs/20260316-bsu-security-reference-v1.00F.md` | BINDABLE | yes | check-secret-naming.sh, check-added-security-definer.mjs, check-cross-tenant-references.mjs |
| `business-suite-unified/docs/20260418-auth-dashboard-hardening-v1.00F.md` | BINDABLE | yes | verify-bs-oauth-session-sync.mjs, check-secret-naming.sh, secret-naming-drift.yml |
| `business-suite-unified/docs/20260723-developer-portal-remaining-work-feature-v1.00F.md` | BINDABLE | yes | check-shared-package-reach.mjs, check-own-package-freshness.mjs, shared-package-reach-lint.yml |
| `business-suite-unified/docs/20260827-rebase-merge-strips-signatures-v1.00F.md` | BINDABLE | yes | check-main-head-is-verified.mjs, main-head-must-be-verified.yml |
| `business-suite-unified/docs/plans/20260504-adopt-dnd-dashboard-v1.00F.md` | BINDABLE | yes | ci.yml |
| `conduit/docs/20260723-schema-builder-registry-consolidation-chore-v1.00F.md` | BINDABLE | yes | check-own-package-freshness.mjs, check-shared-package-reach.mjs, check-zero-consumers.mjs |
| `conduit/docs/plans/20260504-shadcn-init-v1.00F.md` | BINDABLE | yes | check-base-stack-only.mjs, prerender.mjs, base-stack-only.yml |
| `crm7/docs/20260316-crm7-document-storage-implementation-v1.00F.md` | BINDABLE | yes | lint-postgrest-columns.mjs, lint-rls-jwt-claims.sh, check-entity-store-tenant-scope.mjs |
| `crm7/docs/20260818-sub-org-consent-links-design-v1.00W.md` | BINDABLE |  | mutation-test-tenant-links.sh |
| `crm7/docs/20260827-rebase-merge-strips-signatures-v1.00F.md` | BINDABLE | yes | check-main-head-is-verified.mjs, main-head-must-be-verified.yml |
| `crm7/docs/audits/20260811-pgtap-evidence-integrity-v1.00F.md` | BINDABLE | yes | pgtap.yml |
| `crm7/docs/plans/20260423-bsuite-gto-master-plan-v1.00F.md` | BINDABLE | yes | audit-invalid-utilities.sh, check-added-regex-assertions.mjs, lint-rls-jwt-claims.sh |
| `crm7/docs/plans/20260423-ws3-to-ws9-implementation-plan-v1.00F.md` | BINDABLE | yes | check-edge-function-types.mjs, check-edge-function-slug-collisions.mjs, edge-function-typecheck.yml |
| `crm7/docs/plans/STATUS.md` | BINDABLE |  | phase7-5-dialog-title-sweep.mjs |
| `crm7/docs/UNIFIED-ROADMAP.md` | BINDABLE |  | phase7-5-dialog-title-sweep.mjs |
| `docs/00-roadmap/20260112-master-roadmap-v1.00F.md` | BINDABLE | yes | check-doc-naming.mjs, audit-doc-completion.mjs, audit-routes.sh |
| `docs/00-roadmap/20260808-intake-and-onboarding-findings-v1.00W.md` | BINDABLE |  | reencrypt-sensitive-documents.mjs |
| `docs/00-roadmap/20260809-class-a-baseline-before-the-batch-v1.00F.md` | BINDABLE | yes | verify-class-a-preservation.mjs |
| `docs/00-roadmap/20260810-r804-carryover-register-v1.00W.md` | BINDABLE |  | app-quality-checks.yml, build-and-test.yml |
...
| `docs/00-roadmap/20260812-estate-remaining-work-register-v1.00F.md` | BINDABLE | yes | ci.yml |
| `docs/00-roadmap/20260812-pi-run-handback-v1.00W.md` | BINDABLE |  | sync-inline-eslint-rules.mjs, ci.yml |
| `docs/00-roadmap/20260827-one-row-one-truth-alignment-process-v1.00W.md` | BINDABLE |  | estate-align.mjs, estate-alignment.yml |
| `docs/00-roadmap/BSUITE-COMPONENT-REGISTRY.md` | BINDABLE |  | generate-component-registry.mjs |
| `docs/00-roadmap/BSUITE-FEATURE-INDEX.md` | BINDABLE |  | check-base-stack-only.mjs, check-script-parity.sh, audit-legibility.mjs |
| `docs/00-roadmap/DOD-ENFORCEMENT-PROMPT.md` | BINDABLE |  | estate-align.mjs, estate-alignment.yml |
| `docs/00-roadmap/README.md` | BINDABLE |  | generate-docs-directory-index.mjs |
| `docs/20260227-contributing-standards-guide-v1.01W.md` | BINDABLE |  | parse-closing-keywords.mjs, guard-registry.mjs, development-merge-issue-closer.yml |
| `docs/20260227-dry-one-shot-architecture-v1.04A.md` | BINDABLE |  | audit-one-shot.mjs, dry-lint.yml |
| `docs/20260506-dependency-bump-checklist-v1.00A.md` | BINDABLE |  | regen-consumer-lockfile.mjs |
...
| `docs/20260810-plan-dashboard-retirement-v1.00F.md` | BINDABLE | yes | verify-class-a-preservation.mjs |
...
| `docs/20260817-estate-completion-ledger-v1.00W.md` | BINDABLE |  | build-allowance-catalogue.mjs, db-lint.yml |
| `docs/20260817-estate-remaining-work-register-v3.00W.md` | BINDABLE |  | api-availability.mjs, reachability.mjs, prerender.mjs |
| `docs/20260817-recovered-verdict-backlog-v1.00W.md` | BINDABLE |  | prerender.mjs |
| `docs/20260819-built-unlanded-and-unwired-register-v1.00F.md` | BINDABLE | yes | check-hook-suppression-ratchet.mjs, audit-routes.sh, check-placement-rate-provenance.mjs |
| `docs/20260821-airtable-class-data-surface-plan-v1.00F.md` | BINDABLE | yes | check-shared-package-reach.mjs, check-table-reach.mjs |
| `docs/20260822-border-elevation-token-system-spec-v1.00F.md` | BINDABLE | yes | audit-oklch-lightness.py, test-theme-audit-gates.sh, theme-conformance.yml |
...
| `docs/20260824-estate-execution-backlog-v1.00W.md` | BINDABLE |  | audit-one-shot.mjs, check-doc-naming.mjs, audit-doc-completion.mjs |
| `docs/20260824-preview-canary-publishing-standard-v1.00A.md` | BINDABLE |  | check-publish-dist-tag-wiring.mjs, check-no-prerelease-in-production.mjs, audit-legibility.mjs |
| `docs/20260824-role-capabilities-merged-not-applied-root-cause-v1.00F.md` | BINDABLE | yes | audit-role-capability-divergence.mjs, role-capability-divergence.yml |
| `docs/20260825-full-surface-clearance-prompt-v1.00A.md` | BINDABLE |  | audit-routes.sh, check-workflow-path-reachability.mjs, check-supabase-advisors.mjs |
| `docs/20260825-limb-a-is-detectable-limb-b-is-not-v1.00A.md` | BINDABLE |  | audit-doc-supersession.mjs, audit-doc-completion.mjs |
| `docs/20260825-operator-intent-lock-v1.00A.md` | BINDABLE |  | prod-window.sh, intent-audit.sh |
| `docs/20260825-overnight-autonomous-run-v1.00A.md` | BINDABLE |  | audit-routes.sh, check-worktree-hazards.mjs, check-migration-collisions-at-branch-tips.mjs |
| `docs/20260825-overnight-ninety-item-clearance-directive-v1.00A.md` | BINDABLE |  | check-doc-naming.mjs, audit-doc-supersession.mjs, audit-routes.sh |
| `docs/20260826-doc-completion-verdict-v1.00A.md` | BINDABLE |  | audit-doc-completion.mjs, audit-doc-supersession.mjs, check-shared-package-reach.mjs |
| `docs/20260826-morning-brief-v1.00W.md` | BINDABLE |  | check-route-surface-map.mjs, prod-window.sh |
| `docs/20260826-route-surface-map-v1.00W.md` | BINDABLE |  | check-route-surface-map.mjs, build-surface-map.mjs, export-surface-map.mjs |
| `docs/20260826-the-seven-anon-security-definer-functions-v1.00A.md` | BINDABLE |  | check-added-security-definer.mjs |
| `docs/20260828-unearned-completion-markers-triage-plan-v1.00W.md` | BINDABLE |  | audit-doc-completion.mjs |
| `docs/20260829-enhanceddatatable-is-not-a-one-edit-conversion-v1.00W.md` | BINDABLE |  | check-airtable-grid-adoption.mjs |
| `docs/20260829-what-the-capability-denials-actually-do-v1.00D.md` | BINDABLE |  | check-table-reach.mjs, check-zero-consumers.mjs |
| `docs/20260829-why-a-good-speed-score-and-a-slow-app-v1.00D.md` | BINDABLE |  | check-speed-insights-route.mjs |
| `docs/audits/README.md` | BINDABLE |  | generate-docs-directory-index.mjs |
| `docs/CONSISTENCY-REPORT.md` | BINDABLE |  | check-oauth-boot-wiring.mjs, phase7-5-dialog-title-sweep.mjs, estate-invariants.yml |
...
| `docs/plans/20260716-bsuite-completion-program-plan-v1.00F.md` | BINDABLE | yes | drift-scan.mjs |
| `docs/plans/20260728-gap-remediation-plan-v1.00F.md` | BINDABLE | yes | prod-migration-history-audit.yml |
...
| `docs/plans/20260807-data-platform-completion-program-v1.00D.md` | BINDABLE |  | replay-schema-diff.sh |
| `docs/plans/20260810-people-organisations-onboarding-implementation-v1.00W.md` | BINDABLE |  | verify-class-a-preservation.mjs |
| `docs/plans/20260811-post-persona-execution-refined-v1.00W.md` | BINDABLE |  | reachability.mjs |
...
| `docs/plans/20260817-estate-completion-plan-v1.00D.md` | BINDABLE |  | api-availability.mjs |
| `docs/plans/20260827-estate-lifecycle-process-refined-v1.00D.md` | BINDABLE |  | check-doc-naming.mjs, check-doc-classification.mjs, audit-doc-completion.mjs |
| `docs/plans/codehouse-parity/README.md` | BINDABLE |  | generate-docs-directory-index.mjs |
| `docs/plans/loop-contracts/README.md` | BINDABLE |  | generate-docs-directory-index.mjs |
| `docs/plans/STATUS.md` | BINDABLE |  | check-lockfile-hygiene.mjs, drift-scan.mjs |
| `docs/recovered/20260304-document-esign-best-practice-research-v1.00W.md` | BINDABLE |  | drift-scan.mjs |
| `docs/references/20260730-elements-of-rate-calculation-v1.00W.md` | BINDABLE |  | check-placement-rate-provenance.mjs, check-placement-award-code.mjs |
| `docs/research/README.md` | BINDABLE |  | generate-docs-directory-index.mjs |
...
| `docs/validation/README.md` | BINDABLE |  | generate-docs-directory-index.mjs |
| `R80.4/docs/00-roadmap/20260812-r804-branch-model-v1.00W.md` | BINDABLE |  | verify.yml |
| `R80.4/docs/00-roadmap/20260818-r804-master-roadmap-v1.00A.md` | BINDABLE |  | build-apprentice-ladder.mjs, reachability.mjs, dod.mjs |
| `R80.4/docs/00-roadmap/20260819-r8-operator-notes-verification-v1.00A.md` | BINDABLE |  | reachability.mjs, run-tests.mjs, dod.mjs |
| `R80.4/docs/00-roadmap/20260819-r804-production-completion-plan-v1.00A.md` | BINDABLE |  | check-eslint-rule-parity.mjs, dod.mjs, reachability.mjs |
| `R80.4/docs/00-roadmap/20260820-datum-directive-to-r8-lane-v1.00A.md` | BINDABLE |  | dod.mjs |
| `R80.4/docs/00-roadmap/20260820-datum-directive-to-r8-lane-v1.00F.md` | BINDABLE | yes | dod.mjs |
| `R80.4/docs/20260807-award-modelling-next-stage-brief-v1.00W.md` | BINDABLE |  | dod.mjs |
| `R80.4/docs/QUEUE-COMPLETE.md` | BINDABLE | yes | dod.mjs |
...
| `docs/ai/features/20260227-feature-map-complete-v1.00W.md` | UNBOUND |  | — |
...
| `braden/docs/20260316-braden-roadmap-v1.00F.md` | RECORD | yes | — |
| `braden/docs/20260723-theme-canonicalisation-decision-v1.00F.md` | RECORD | yes | — |
...
| `business-suite-unified/docs/20260316-bsu-crm7-rbac-rls-reference-v1.00F.md` | RECORD | yes | lint-rls-jwt-claims.sh, check-added-security-definer.mjs, check-entity-store-tenant-scope.mjs |
| `business-suite-unified/docs/20260316-bsu-crm7-supabase-audit-v1.00F.md` | RECORD | yes | — |
| `business-suite-unified/docs/20260316-bsu-supabase-apply-runbook-v1.00F.md` | RECORD | yes | check-schema-lag.mjs, check-phantom-migrations.mjs, check-migration-collisions-across-open-prs.mjs |
| `business-suite-unified/docs/archive/README.md` | RECORD |  | — |
| `business-suite-unified/docs/plans/20260504-adopt-entity-selectors-v1.00F.md` | RECORD | yes | audit-one-shot.mjs |
| `conduit/docs/archive/README.md` | RECORD |  | — |
| `conduit/docs/plans/20260504-adopt-entity-selectors-v1.00F.md` | RECORD | yes | audit-one-shot.mjs |
| `crm7/docs/00-roadmap/20260226-crm7-master-roadmap-v1.00A.md` | RECORD |  | — |
| `crm7/docs/00-roadmap/README.md` | RECORD |  | — |
| `crm7/docs/20260730-placements-classification-fixed-id-review-v1.00F.md` | RECORD | yes | — |
| `crm7/docs/adr/README.md` | RECORD |  | — |
| `crm7/docs/architecture/README.md` | RECORD |  | — |
| `crm7/docs/archive/README.md` | RECORD |  | — |
| `crm7/docs/audits/20260811-colour-drift-full-tree-audit-v1.00F.md` | RECORD | yes | lint-ratchet.mjs, sync-inline-eslint-rules.mjs, drift-scan.mjs |
| `crm7/docs/deployment/README.md` | RECORD |  | — |
| `crm7/docs/guides/README.md` | RECORD |  | — |
| `crm7/docs/operations/20260610-migration-history-post-baseline-drift-v1.00F.md` | RECORD | yes | — |
| `crm7/docs/plans/archive/README.md` | RECORD |  | — |
| `docs/00-roadmap/20260725-excellence-closeout-implementation-plan-v1.00F.md` | RECORD | yes | publish-ui.yml |
| `docs/00-roadmap/20260725-qwen-excellence-integration-plan-v1.00F.md` | RECORD | yes | — |
| `docs/00-roadmap/20260808-operator-decision-register-v1.00W.md` | RECORD |  | reencrypt-sensitive-documents.mjs |
| `docs/00-roadmap/20260809-pre-apply-capture-bsuite-1845-v1.00F.md` | RECORD | yes | — |
| `docs/00-roadmap/20260809-shipped-to-production-v1.00W.md` | RECORD |  | — |
| `docs/00-roadmap/20260810-dashboard-scope-ruling-v1.00F.md` | RECORD | yes | — |
| `docs/00-roadmap/20260810-document-provenance-who-creates-what-v1.00F.md` | RECORD | yes | — |
| `docs/20260225-founding-brief-and-what-became-of-it-v1.00F.md` | RECORD | yes | — |
| `docs/20260427-conduit-auth-doctrine-investigation-v1.00F.md` | RECORD | yes | — |
| `docs/20260427-dev-main-fork-rca-v1.00F.md` | RECORD | yes | — |
| `docs/20260427-security-definer-audit-v1.00F.md` | RECORD | yes | — |
| `docs/20260506-apprentice-placement-avetmiss-nat00120-mapping-v1.00F.md` | RECORD | yes | check-edge-function-types.mjs, check-edge-function-slug-collisions.mjs, edge-function-typecheck.yml |
| `docs/20260506-apprentice-placement-form-schema-spec-v1.00F.md` | RECORD | yes | lint-postgrest-columns.mjs, build-and-test.yml, postgrest-column-lint.yml |
| `docs/20260506-reports-parity-spec-v1.00F.md` | RECORD | yes | — |
| `docs/20260506-table-usage-audit-v1.00F.md` | RECORD | yes | — |
| `docs/20260519-rpc-report-page-security-review-v1.00F.md` | RECORD | yes | — |
| `docs/20260725-headroom-learn-notes-v1.00F.md` | RECORD | yes | — |
| `docs/20260727-docs-deep-dive-inventory-v1.00F.md` | RECORD | yes | — |
| `docs/20260727-extreme-poor-agent-items-execution-v1.00F.md` | RECORD | yes | — |
| `docs/20260727-schema-package-pin-plan-v1.00F.md` | RECORD | yes | check-shared-package-reach.mjs, check-own-package-freshness.mjs |
| `docs/20260728-migration-idempotency-audit-v1.00F.md` | RECORD | yes | — |
| `docs/20260728-operator-ux-bug-register-v1.00F.md` | RECORD | yes | — |
| `docs/20260728-weekly-gap-register-v1.00F.md` | RECORD | yes | — |
| `docs/20260814-estate-remaining-work-register-v2.00F.md` | RECORD | yes | audit-d2c-theme.sh, theme-conformance.yml |
| `docs/20260814-notes-backlog-verification-register-v1.00F.md` | RECORD | yes | check-theme-gate-app-lists.mjs, audit-hittable-actions.mjs, check-colour-ban-reaches-converters.mjs |
| `docs/20260819-estate-session-evidence-v1.00F.md` | RECORD | yes | — |
| `docs/20260821-atmosphere-evaluation-v1.00F.md` | RECORD | yes | check-shared-package-reach.mjs |
| `docs/20260822-data-surface-consolidation-decision-v1.00D.md` | RECORD |  | check-doc-classification.mjs |
| `docs/20260822-estate-doc-inventory-v1.00W.md` | RECORD |  | audit-doc-completion.mjs, verify-class-a-preservation.mjs, verify-esm-imports.sh |
| `docs/20260822-session-findings-register-v1.00W.md` | RECORD |  | audit-doc-completion.mjs, check-doc-citations-resolve.mjs, check-table-reach.mjs |
| `docs/20260824-doc-completion-bar-measured-v1.00F.md` | RECORD | yes | audit-doc-completion.mjs, check-shared-package-reach.mjs, check-doc-classification.mjs |
| `docs/20260824-role-capabilities-zero-consumer-finding-v1.00F.md` | RECORD | yes | check-table-reach.mjs, check-zero-consumers.mjs |
| `docs/20260825-atmosphere-is-nocodb-and-the-licence-already-ruled-v1.00A.md` | RECORD |  | check-shared-package-reach.mjs |
| `docs/20260825-braden-group-duplicated-documents-v1.00D.md` | RECORD |  | remediate-duplicated-documents.mjs |
| `docs/20260825-consolidation-assessment-v1.00W.md` | RECORD |  | — |
| `docs/20260825-estate-consolidated-findings-v1.00W.md` | RECORD |  | reencrypt-sensitive-documents.mjs, publish-eslint-config.yml |
| `docs/20260825-operator-notes-register-d1-d103-v1.00W.md` | RECORD |  | — |
| `docs/20260825-remeasured-clearance-brief-v1.00A.md` | RECORD |  | — |
| `docs/20260826-backend-surface-asymmetries-v1.00D.md` | RECORD |  | — |
| `docs/20260826-four-decisions-for-braden-v1.00D.md` | RECORD |  | audit-role-capability-divergence.mjs, check-route-surface-map.mjs |
| `docs/20260826-futurebuild-production-acceptance-v1.00D.md` | RECORD |  | — |
| `docs/20260826-morning-ledger-v1.00A.md` | RECORD |  | — |
| `docs/20260826-page-builder-2x-layout-in-production-measured-v1.00A.md` | RECORD |  | audit-routes.sh |
| `docs/20260826-supabase-advisor-posture-measured-v1.00A.md` | RECORD |  | check-supabase-advisors.mjs, audit-security-definer-guards.mjs |
| `docs/20260828-messaging-platform-design-v1.00W.md` | RECORD |  | — |
| `docs/20260830-nav-route-reachability-across-the-five-non-crm7-apps-v1.00D.md` | RECORD |  | — |
| `docs/20260830-text-contrast-across-the-estate-v1.00D.md` | RECORD |  | audit-d2c-theme.sh, audit-applied-tokens.mjs |
...
| `docs/adr/ADR-0009-funding-refinement-semantics.md` | RECORD |  | check-placement-rate-provenance.mjs, schema-lag.yml |
| `docs/adr/ADR-0010-fix-the-class-not-the-page.md` | RECORD |  | estate-align.mjs, estate-alignment.yml |
...
| `docs/audits/20260725-bsu-braden-throughput-docs-code-audit-v1.00W.md` | RECORD |  | — |
| `docs/audits/20260725-conduit-r80-deep-bug-excavation-v1.00W.md` | RECORD |  | — |
| `docs/audits/20260725-conduit-r80-docs-code-audit-v1.00F.md` | RECORD | yes | — |
| `docs/audits/20260725-crm7-deep-bug-excavation-v1.00F.md` | RECORD | yes | — |
| `docs/audits/20260725-crm7-docs-code-audit-v1.00F.md` | RECORD | yes | — |
| `docs/audits/20260725-dead-duplicate-code-audit-v1.00W.md` | RECORD |  | check-docs-table-cells.mjs |
| `docs/audits/20260725-jodie-parity-matrix-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260506-codehouse-parity/20260506-portal-braden-marketing-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260506-codehouse-parity/20260506-portal-bsu-admin-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260506-codehouse-parity/20260506-portal-bsu-tenant-admin-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260506-codehouse-parity/20260506-portal-conduit-candidate-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260506-codehouse-parity/20260506-portal-conduit-careers-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260506-codehouse-parity/20260506-portal-conduit-employer-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260506-codehouse-parity/20260506-portal-conduit-recruiter-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260506-codehouse-parity/20260506-portal-crm7-internal-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260506-codehouse-parity/20260506-portal-r80-3-calculator-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260507-feature-builder-ux-red-team-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260510-universal-canvas-capability-implementation-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260521-reports-w2-uplift-implementation-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260617-product-tails-continuation-prompt-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260629-bsuite-remaining-work-roadmap-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260629-remaining-work-continuation-prompt-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260703-gto-e2e-gap-map-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260709-hermes-deep-dive-audit-prompt-refined-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260723-completion-program-refined-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260725-docs-deadcode-archive-refined-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260725-gto-excellence-program-refined-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260727-escalation-council-multiapp-investigation-refined-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260728-billing-model-label-truthfulness-refined-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260728-ux-implementation-plan-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260728-ux-implementation-round2-plan-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260728-weekly-gap-assessment-plan-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260729-qa-backlog-execution-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260729-unified-authoring-redteam-refined-v1.00F.md` | RECORD | yes | — |
| `docs/plans/20260824-agent-compliance-enforcement-refined-v1.00W.md` | RECORD |  | — |
| `docs/plans/inputs/20260506-codehouse-parity-prompt-enhancer-output-v1.00F.md` | RECORD | yes | — |
| `docs/plans/inputs/20260814-portals-lane-kickoff-prompt-v1.00W.md` | RECORD |  | theme-conformance.yml |
| `docs/plans/inputs/README.md` | RECORD |  | generate-docs-directory-index.mjs |
| `docs/plans/loop-contracts/20260817-recruitment-comms-rams-loop-contract-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260225-cascade-claude-upgrade-coordination-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260226-prerender-seo-marketing-plan-v1.0.0-v1.00F.md` | RECORD | yes | prerender.mjs |
| `docs/recovered/20260226-recruit7-candidate-sourcing-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260226-report-implementation-summary-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260227-ai-assistant-plugin-system-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260227-e2e-flows-google-azure-setup-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260228-conduit-ai-tools-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260301-phase1-coordination-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260301-reconciliation-phase1-implementation-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260302-vercel-deployment-fix-cc2-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260303-bsuite-launch-ready-design-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260304-crm7-comprehensive-audit-report-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260304-crm7-comprehensive-gap-analysis-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260304-crm7-document-lifecycle-design-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260304-crm7-document-lifecycle-implementation-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260305-wif-migration-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260425-universal-canvas-master-execution-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/20260630-cross-app-auth-validation-dev-deploy-test-plan-v1.00F.md` | RECORD | yes | — |
| `docs/recovered/cozy-stirring-teacup-agent-a38474b.md` | RECORD |  | — |
| `docs/recovered/gleaming-fluttering-coral.md` | RECORD |  | — |
| `docs/recovered/idempotent-baking-tarjan-agent-ac048d4.md` | RECORD |  | — |
| `docs/recovered/reactive-growing-waterfall-agent-a8e1b8c.md` | RECORD |  | — |
| `docs/recovered/reactive-growing-waterfall.md` | RECORD |  | — |
| `docs/recovered/rustling-mapping-lemon.md` | RECORD |  | — |
| `docs/recovered/tranquil-weaving-robin.md` | RECORD |  | — |
| `docs/recovered/wf1-ots-parity-implementation-229a69.md` | RECORD |  | — |
| `docs/validation/20260731-gto-enquiry-to-billing-walk-results-v1.00F.md` | RECORD | yes | — |
| `docs/validation/20260804-operator-notes-defect-register-v1.00F.md` | RECORD | yes | — |
| `R80.4/docs/handoff/20260804-r804-to-pi-v1.00F.md` | RECORD | yes | — |
| `throughput/docs/20260425-throughput-outstanding-v1.00F.md` | RECORD | yes | — |
| `throughput/docs/archive/README.md` | RECORD |  | — |
| `throughput/docs/plans/archive/README.md` | RECORD |  | — |

  unbound ratchet ok: baseline 274, now 274

  unearned-marker ratchet ok: baseline 0, now 0
