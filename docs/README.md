...
- **Current planning and dispatch:** [14 September Codex IDE kickoff](plans/20260914-codex-ide-closeout-refined-v1.00W.md) and [370-row remediation pack](plans/20260908-remediation/README.md), reconciled with live issue/PR/deployment evidence. Historical registers preserve requirements and evidence; they do not override current ownership or status.
...
| File | Description |
|------|-------------|
| Archived August remaining-work register (`/home/braden/Desktop/Dev/archived-repos-docs/20260831-bsuite-docs-archive-pass/docs/20260814-estate-remaining-work-register-v2.00F.md`) | Historical August audit of266 documents; preserve its requirements and dated evidence. Current dispatch/status: [370-row pack](plans/20260908-remediation/README.md), refreshed against live evidence. |
...
| `OUTSTANDING.md` | Historically superseded by the August register; retained for its evidence trail. Current dispatch/status: [370-row pack](plans/20260908-remediation/README.md). |
