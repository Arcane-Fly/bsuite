...
- **Canonical planning and delivery source of truth:** `20260817-estate-remaining-work-register-v3.00W.md` (below). The former v2 register is archived at `~/Desktop/Dev/archived-repos-docs/20260831-bsuite-docs-archive-pass/docs/`.
...
| File | Description |
|------|-------------|
| `20260817-estate-remaining-work-register-v3.00W.md` | **Canonical remaining-work register — for item definitions and evidence; superseded for *status* by `20260817-estate-completion-ledger-v1.00W.md`.** The former v2 register is archived at `~/Desktop/Dev/archived-repos-docs/20260831-bsuite-docs-archive-pass/docs/`. |
...
| `OUTSTANDING.md` | **Archived out of the repo** — superseded 2026-08-14 by the v2 register, now superseded by `20260817-estate-remaining-work-register-v3.00W.md`; historical copy is in the external archive |
...
| `20260519-rpc-report-page-security-review-v1.00F.md` | **Archived out of the repo** — report page / RPC security review, frozen 2026-08-28; approved 2026-05-19 and never implemented, superseded by the `report_catalog_*` family |
...
> **Parity-spec status correction (2026-08-14):** the nine tracking issues for these specs are closed as `completed`, but each was closed on the day its spec document merged. Measured 2026-08-14, **26 of the 36 tables they define do not exist**. See the current `20260817-estate-remaining-work-register-v3.00W.md` §3 before treating any of these as delivered.
...
| `20260817-estate-remaining-work-register-v3.00W.md` | **Canonical remaining-work register** (also indexed under Roadmaps above) — the full estate audit: 8 P0s, the money/compliance block, the parity-program correction, adoption gaps, verification-integrity holes, theme/perf, portals, doc hygiene, and what no static pass can settle. |

### Directories

| Directory | Description |
|-----------|-------------|
| [`adr/`](adr/README.md) | Architecture decision records (ADR-0001…ADR-0011) |
...
| `design-inputs/` | Design source files and imported visual planning inputs |
| `evidence/` | Evidence captures referenced by plans/audits (machine assets; no Markdown index) |
| `nav/` | Navigation and route documentation |
| `research/` | Research notes and source analyses |
| `validation/` | Generated validation indexes and verification records |
| `security/` | Security allowlists and machine-readable security records |
