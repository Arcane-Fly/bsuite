...
- **Current human work lifecycle:** [Linear work-tracking contract](20260924-linear-work-tracking-v1.00W.md) and the [BSuite project](https://linear.app/braden-pty-ltd/project/bsuite-delivery-and-roadmap-806afbd51657). [BRA-46](https://linear.app/braden-pty-ltd/issue/BRA-46/centralize-bsuite-work-in-linear-and-retire-conflicting-tracking) tracks migration coverage; do not assume every old row is mapped yet. The [14 September kickoff](plans/20260914-codex-ide-closeout-refined-v1.00W.md) and [370-row remediation pack](plans/20260908-remediation/README.md) preserve source IDs and execution context, while live local checkpoints retain dispatch leases.
...
- Archived August remaining-work register (`/home/braden/Desktop/Dev/archived-repos-docs/20260831-bsuite-docs-archive-pass/docs/20260814-estate-remaining-work-register-v2.00F.md`) preserves historical acceptance and evidence. Consult the linked Linear outcome for current human status, the local checkpoint for writer ownership, and fresh live receipts for technical claims.
- Project `docs/README.md` files are navigation hubs only
- `docs/plans/` contains plans whose remaining acceptance must reconcile into the current execution pack and live issue evidence.
...
| File | Description |
|------|-------------|
| `20260924-linear-work-tracking-v1.00W.md` | Current authority boundaries for Linear lifecycle, GitHub evidence, local leases and the still-open migration. |
| Archived August remaining-work register (`/home/braden/Desktop/Dev/archived-repos-docs/20260831-bsuite-docs-archive-pass/docs/20260814-estate-remaining-work-register-v2.00F.md`) | Historical August audit of 266 documents; preserve requirements and dated evidence. Current human status is in the linked Linear outcome after mapping; retain unresolved IDs under BRA-46. |
| `20260817-estate-completion-ledger-v1.00W.md` | Dated, append-only August evidence for register items and coverage gaps. Read the top amendment with its date; its historical counts are not current lifecycle status. Keep its stable identifiers in the Linear crosswalk. |
...
| `OUTSTANDING.md` | Historical evidence trail; reconcile its remaining source IDs under BRA-46. Current lifecycle is in the linked Linear outcome; dispatch leases remain local. |
...
| `20260427-security-definer-audit-v1.00F.md` | SECURITY DEFINER privilege-escalation audit — `public.is_team_admin` + WS-G helpers (recovered from a stash 2026-08-05; verify findings against the live catalog before acting) |
...
| `20260519-rpc-report-page-security-review-v1.00F.md` | Report page / RPC security review — **frozen 2026-08-28**; approved 2026-05-19 and never implemented, superseded by the `report_catalog_*` family |
...
| `20260506-table-usage-audit-v1.00F.md` | Table usage audit — conclusions stand, but each drop recommendation needs human sign-off (recovered from a stash 2026-08-05). **Counts are stale**: 229 tables recorded, **402 live** (re-measured 2026-08-17 — the doc now carries a banner saying so) |
...
| Archived August remaining-work register (`/home/braden/Desktop/Dev/archived-repos-docs/20260831-bsuite-docs-archive-pass/docs/20260814-estate-remaining-work-register-v2.00F.md`) | Historical August audit of 266 documents; preserve requirements and dated evidence. Use the Linear crosswalk and current live receipts for present status. |
