...
| **PARTIAL** | ~~13~~ ~~14~~ **15** | Half shipped. Real work remains — counted as open below. |
| **OPEN** | ~~54~~ ~~50~~ **49** | Untouched, or the fix exists but has not reached the running system. |
| **Total** | **87** | |

**Closed: ~~20~~ 23. Carrying work: ~~67~~ 64** (~~14~~ 15 partial + ~~50~~ 49 open) — roughly **31 small, 23
