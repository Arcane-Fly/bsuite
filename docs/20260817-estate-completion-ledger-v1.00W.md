...
|---|---:|---|
| **DONE** | **32** | Re-measured fixed, with evidence. No work remains. |
...
| **PARTIAL** | **23** | Half shipped. Real work remains — counted as open below. |
| **OPEN** | **20** | Untouched, or the fix exists but has not reached the running system. |
| **Total** | **80** | |
