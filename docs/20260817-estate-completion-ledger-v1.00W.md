...
| **PARTIAL** | ~~13~~ ~~14~~ ~~13~~ ~~14~~ **15** | Half shipped. Real work remains — counted as open below. |
| **OPEN** | ~~54~~ ~~50~~ ~~48~~ ~~45~~ ~~39~~ ~~37~~ ~~34~~ **33** | Untouched, or the fix exists but has not reached the running system. |
| **Total** | **87** | |
