...
| **OPEN** | ~~54~~ ~~50~~ **48** | Untouched, or the fix exists but has not reached the running system. |
| **Total** | **87** | |

**Closed: ~~20~~ ~~23~~ 26. Carrying work: ~~67~~ ~~64~~ 61** (13 partial + 48 open). Corrected
