...
The PR evidence template lives in the `bsuite-ship-visual-promote` skill (canonical home
`~/.agents/skills/`), visual-inspection protocol reference, §8. The skill carries the
matching rule text and the template; this document is the repo-side authority.
