...
| Host employer management, placements | Yes — `crm7` hosts/placements pages | Yes — "Workforce One Hirings" (placements), Client Pipeline, Summary Client hierarchy | `docs/20260723-Anytime-WorkforceOne-Admin-Guide.md` §PLACEMENTS; `codehouse-knowledgebase-crawl.md` rows 20-21 | Parity |
...
| Leave application workflow | Not verified this session | Yes — full apply/approve/reject/unsubmit leave cycle | `docs/20260723-Anytime-WorkforceOne-Admin-Guide.md` §APPLY LEAVE | Unverified on BSuite side |
