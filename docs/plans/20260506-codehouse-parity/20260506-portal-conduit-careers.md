...
| `candidate` (post-application) | Conduit Supabase Native Auth (auto-created on first apply) | becomes `candidate` role per [`20260506-portal-conduit-candidate.md`](./20260506-portal-conduit-candidate.md) |
