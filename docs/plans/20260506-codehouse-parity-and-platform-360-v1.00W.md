...
|---|---|---|
| Refined prompt (heavy-tier, 5-pass, 192 lines) | [`docs/plans/inputs/20260506-codehouse-parity-prompt-enhancer-output.md`](./inputs/20260506-codehouse-parity-prompt-enhancer-output.md) | Workstream decomposition (WS-A through WS-F), best-practice citations, blindspot register, skills/MCPs list |
...
|---|---|---|---|---|
| 1 | BSU admin (platform) | [`20260506-portal-bsu-admin.md`](./20260506-codehouse-parity/20260506-portal-bsu-admin.md) | business-suite-unified | W |
| 2 | CRM7 internal (consultant/coordinator) | [`20260506-portal-crm7-internal.md`](./20260506-codehouse-parity/20260506-portal-crm7-internal.md) | crm7 | W |
| 3 | Conduit recruiter | [`20260506-portal-conduit-recruiter.md`](./20260506-codehouse-parity/20260506-portal-conduit-recruiter.md) | conduit | W |
| 4 | Conduit candidate | [`20260506-portal-conduit-candidate.md`](./20260506-codehouse-parity/20260506-portal-conduit-candidate.md) | conduit | W |
| 5 | Conduit employer | [`20260506-portal-conduit-employer.md`](./20260506-codehouse-parity/20260506-portal-conduit-employer.md) | conduit | W |
| 6 | Conduit careers (public) | [`20260506-portal-conduit-careers.md`](./20260506-codehouse-parity/20260506-portal-conduit-careers.md) | conduit | W |
| 7 | BSU tenant admin | [`20260506-portal-bsu-tenant-admin.md`](./20260506-codehouse-parity/20260506-portal-bsu-tenant-admin.md) | business-suite-unified | W |
| 8 | R80.3 calculator user | [`20260506-portal-r80-3-calculator.md`](./20260506-codehouse-parity/20260506-portal-r80-3-calculator.md) | R80.3 | W |
| 9 | Braden marketing | [`20260506-portal-braden-marketing.md`](./20260506-codehouse-parity/20260506-portal-braden-marketing.md) | braden | W |

---

## 6. Visual feature builder

Spec: [`20260506-codehouse-parity/20260506-visual-feature-builder-spec.md`](./20260506-codehouse-parity/20260506-visual-feature-builder-spec.md).
...
2. ✅ The refined-prompt copy-in exists at `docs/plans/inputs/20260506-codehouse-parity-prompt-enhancer-output.md` and is byte-identical to the source.
3. ✅ All 9 portal sub-plans exist under `docs/plans/20260506-codehouse-parity/20260506-portal-*.md`, each ≤250 lines.
4. ✅ Visual-feature-builder spec exists at `docs/plans/20260506-codehouse-parity/20260506-visual-feature-builder-spec.md` and is ≤250 lines.
