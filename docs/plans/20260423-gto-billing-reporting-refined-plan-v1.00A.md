...
**Scorecard:** 3/9 fully DONE (WS-2, WS-3, WS-7) · 6/9 partial or mostly-done with gaps flagged (WS-1 package publish blocked; WS-4 alignment evidence already landed via `crm7#948`; WS-5 template seed closed via `crm7#998` with follow-on runnable RPC/query work remaining; WS-6 5 NAT formatters missing; WS-8 pgTap harness closed via `crm7#949`; WS-9 gated + WS-4 dependent).
