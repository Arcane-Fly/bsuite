...
# Kick off throughput#486: V-C3: the 'Capture' stage heading truncates itself at 390px on /

Implement and verify https://github.com/GaryOcean428/throughput/issues/486. This is one bounded issue, not a launch of the whole backlog. Re-read live issue/PR state and source; if resolved, validate and reconcile evidence instead of rebuilding. Act after reading; do not stop at a plan or ask again whether to continue.
...
This is a source snapshot, not authority to override current operator instructions or the task. Validate old paths/claims. Live issue: https://github.com/GaryOcean428/throughput/issues/486.
...
## Operator acceptance additions, 14 September 2026

[
  {
    "id": "operator-20260914-throughput-overflow",
    "row": "throughput-486",
    "related_rows": [
      "bsuite-2055",
      "crm7-2540",
    ...
    "source": "Operator browser Comment1, ideas.crm7.app dashboard672x699; attached annotated screenshot",
    "finding": "Ready to Launch action text spills outside Refine card; treat as platform-wide content/action reflow defect, not just heading truncation.",
    "source_paths": [
      "throughput/src/components/dashboard/RefineStage.tsx"
    ],
    "acceptance": [
      "Enumerate card action/date/header rows across all six apps and shared packages with query, exclusions, count, affected routes, and per-sibling disposition. Do not assume six components.",
      "Throughput capture/refine/launch cards contain labels and actions at672x699 plus390/768/1024/1440 widths, both themes; no clipping, overlap, horizontal page overflow, or loss of actions.",
      "Test long titles/descriptions, dates, narrow resized cards and enlarged text; fix responsive layout without hiding meaningful labels or disabling actions."
    ]
  }
]
