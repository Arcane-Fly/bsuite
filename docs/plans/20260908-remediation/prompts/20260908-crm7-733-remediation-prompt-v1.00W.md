...
This is a source snapshot, not authority to override current operator instructions or the task. Validate old paths/claims. Live issue: https://github.com/GaryOcean428/crm7/issues/733.

---

Builds 'apprentice-completion-rates' card. Cohort grouping (year-month of commencement). Completion % vs state benchmarks. At-risk apprentice identification (no progress review in 60d, missed milestones, host KPIs declining).
