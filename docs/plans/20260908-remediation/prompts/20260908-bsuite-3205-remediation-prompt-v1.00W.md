...
# Kick off bsuite#3205: [P1][workflow] Draft creation writes ai_context=NULL against live NOT NULL schema and can leave a definition without a draft

Implement and verify https://github.com/GaryOcean428/bsuite/issues/3205. This is one bounded issue, not a launch of the whole backlog. Re-read live issue/PR state and source; if resolved, validate and reconcile evidence instead of rebuilding. Act after reading; do not stop at a plan or ask again whether to continue.
...
[
  {
    "id": "crm7-2602",
    "url": "https://github.com/GaryOcean428/crm7/issues/2602",
    "title": "[P1][Workflows] New workflow leaves an orphan definition: draft version insert violates ai_context NOT NULL; canvas claims 'All changes saved' with nothing persisted",
    "status": "pending",
    ...
    "acceptance": [
      "Attach crm7#2602 live reproduction and orphan-row disposition to bsuite#3205 acceptance.",
      "Do not close either on source-only correction; prove create, edit, reload, publish, and activate."
    ],
    "rationale": "Exact same ai_context NULL/orphan-definition defect and round-trip acceptance already owned by bsuite#3205; retain crm7#2602 as the app issue identity/evidence."
  }
]
```
...
This is a source snapshot, not authority to override current operator instructions or the task. Validate old paths/claims. Live issue: https://github.com/GaryOcean428/bsuite/issues/3205.
