# Kick off throughput#479: Jodie's floating button renders a generic SVG, not the Jodie logo — the repo has no /logos/jodie.png

Implement and verify https://github.com/GaryOcean428/throughput/issues/479. This is one bounded issue, not a launch of the whole backlog. Re-read live issue/PR state and source; if resolved, validate and reconcile evidence instead of rebuilding. Act after reading; do not stop at a plan or ask again whether to continue.
...
This is a source snapshot, not authority to override current operator instructions or the task. Validate old paths/claims. Live issue: https://github.com/GaryOcean428/throughput/issues/479.
...
[
  {
    "id": "operator-20260914-throughput-jodie-brand",
    "row": "throughput-479",
    "related_rows": [
      "business-suite-unified-1174"
    ],
    "source": "Operator browser Comment2, ideas.crm7.app dashboard672x699; attached annotated screenshot",
    "finding": "Jodie launcher still uses generic star SVG; same defect already filed September6, not a new issue.",
    "source_paths": [
      "throughput/src/components/JodieFloatingButton.tsx"
    ],
    "acceptance": [
      "Enumerate Jodie launchers/panel marks across all six apps and shared packages; compare against established actual brand asset, not misleading source comment.",
      "Each applicable launcher renders correct Jodie asset with naturalWidth>0 in light/dark and narrow viewport, retains accessible name, keyboard/focus and usable activation.",
      "Check BSU Idea Hub sibling1174; record full inventory and any exceptions with evidence."
    ]
  }
]
