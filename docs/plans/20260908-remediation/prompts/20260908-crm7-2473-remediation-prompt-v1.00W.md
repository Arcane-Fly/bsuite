...
# Kick off crm7#2473: [D-111] Per-tenant visible/hidden marking; tenant-Active distinct from registered/deregistered

Implement and verify https://github.com/GaryOcean428/crm7/issues/2473. This is one bounded issue, not a launch of the whole backlog. Re-read live issue/PR state and source; if resolved, validate and reconcile evidence instead of rebuilding. Act after reading; do not stop at a plan or ask again whether to continue.
...
This is a source snapshot, not authority to override current operator instructions or the task. Validate old paths/claims. Live issue: https://github.com/GaryOcean428/crm7/issues/2473.

---

**Operator's words** (`~/Downloads/bsuite notes (7).docx`, register row D-111, route/surface: /training-providers):

> they should be able to mark training providers they want visible and hidden. Search all, search Active. Active means Active for us… not Active generally.

**The ask:** Per-tenant visible/hidden marking; tenant-Active distinct from registered/deregistered

**Register verdict at filing:** NOT-DONE — No `is_hidden`/`is_visible`/tenant-marking toggle found in `training-providers/index.tsx`.
...
Ruling of record: qig-memory `bsuite_operator_ruling_20260906_agents_own_visual_validation`. Register: `docs/20260825-operator-notes-register-d1-d103-v1.00W.md` row D-111.
