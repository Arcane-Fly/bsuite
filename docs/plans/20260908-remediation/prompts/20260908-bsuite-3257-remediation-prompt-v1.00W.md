...
# Kick off bsuite#3257: Ratchet floor breached: doc classification

Implement and verify https://github.com/GaryOcean428/bsuite/issues/3257. This is one bounded issue in the existing canonical BSuite programme, not a launch of the whole backlog and not a replacement backlog. Re-read live issue/PR state and source; if a limb is already resolved, validate and reconcile exact evidence instead of rebuilding. Act after reading; do not stop at a plan or ask again whether to continue.
...
- **check-documentation** — load `/home/braden/.agents/skills/check-documentation/SKILL.md` and apply only its relevant scope.
- **check-docs-vs-code** — load `/home/braden/.agents/skills/check-docs-vs-code/SKILL.md` and apply only its relevant scope.
...
1. Reconcile all unclassified documentation against the live implementation and current canonical guidance.
2. Restore the ratchet to or below its measured floor without hiding, deleting, or relabeling unresolved requirements.
3. Preserve dated historical records and link each active gap to an owner and issue.
...
This is the live GitHub issue body captured during the 2026-09-14 records reconciliation. It does not override later operator instructions or current repository rules. Live issue: https://github.com/GaryOcean428/bsuite/issues/3257. Captured GitHub updatedAt: 2026-09-13T18:44:08Z.

---

unclassified: 172 of 316 doc(s); floor today: 160 (origin 175 on 2026-09-03, 15/week)
FLOOR BREACHED: 172 > 160.
