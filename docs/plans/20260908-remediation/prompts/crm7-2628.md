...
The only direct workflow consumers of the mutating resolver are `.github/workflows/e2e.yml:88` and `.github/workflows/lighthouse-ci.yml:95`. The only branch deletion call is `e2e.yml:346`; it must be moved to the new lifecycle owner as part of this work.
