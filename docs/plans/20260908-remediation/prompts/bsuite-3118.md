# Kick off bsuite#3118: [EPIC] Operator 2026-09-06 16:23: every agent cleans up — orphan worktrees and branches, work at risk, DoD gaps, unpromoted trees (inventory + required actions)

Implement and verify https://github.com/GaryOcean428/bsuite/issues/3118. This is one bounded issue, not a launch of the whole backlog. Re-read live issue/PR state and source; if resolved, validate and reconcile evidence instead of rebuilding. Act after reading; do not stop at a plan or ask again whether to continue.
...
[
  {
    "id": "bsuite-3087",
    "url": "https://github.com/GaryOcean428/bsuite/issues/3087",
    "title": "Work at risk: branches ahead of development with no PR",
    "status": "pending",
    ...
    "acceptance": [
      "Refresh the branch-at-risk census and disposition each named ref as preserved, merged/promoted, or explicitly blocked.",
      "Never delete a branch from age or naming alone."
    ],
    "rationale": "Automated work-at-risk umbrella is the same branch/worktree preservation programme already owned by bsuite#3118; create no second cleanup dispatcher."
  }
]
```
...
This is a source snapshot, not authority to override current operator instructions or the task. Validate old paths/claims. Live issue: https://github.com/GaryOcean428/bsuite/issues/3118.
