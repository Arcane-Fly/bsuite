...
# Kick off bsuite#3258: Ratchet floor breached: airtable grid adoption

Implement and verify https://github.com/GaryOcean428/bsuite/issues/3258. This is one bounded issue in the existing canonical BSuite programme, not a launch of the whole backlog and not a replacement backlog. Re-read live issue/PR state and source; if a limb is already resolved, validate and reconcile exact evidence instead of rebuilding. Act after reading; do not stop at a plan or ask again whether to continue.
...
- **web-ag-grid** — load `/home/braden/.agents/skills/web-ag-grid/SKILL.md` and apply only its relevant scope.
...
- **general-dry-one-shot-architecture** — load `/home/braden/.agents/skills/general-dry-one-shot-architecture/SKILL.md` and apply only its relevant scope.
...
1. Enumerate hand-rolled list/table sites from route and renderer axes and reconcile the measured denominator.
2. Convert applicable record lists to the canonical editable data-grid contract without weakening non-applicable exceptions.
3. Restore the ratchet floor with deployed keyboard, responsive, permission, save/reload, and failure-path evidence.
...
This is the live GitHub issue body captured during the 2026-09-14 records reconciliation. It does not override later operator instructions or current repository rules. Live issue: https://github.com/GaryOcean428/bsuite/issues/3258. Captured GitHub updatedAt: 2026-09-13T18:44:09Z.

---

hand-rolled render sites: 191 (examined 1509 files); floor today: 186 (origin 192 render sites on 2026-09-03, 6 render sites/week)
FLOOR BREACHED: 191 > 186.
