...
# Continue bsuite-3241: [P1][theme] Replace legacy native scrollbars with shared accessible theme styling across six apps

https://github.com/GaryOcean428/bsuite/issues/3241
...
Use bsuite-brand-system, bsuite-shared-ui-rollouts and bsuite-ship-visual-promote. Shared theme1.5.2-next.0 exists and all six consumer theme PRs merged into development (CRM2612, Conduit715, BSU1234, Braden615, R80.4-324, Throughput493). Parent3254 final reconciliation remains open. Current six-app source gate has21 passing self-tests and24CSS files passing A1/A2; this is not visual acceptance. Conduit desktop light/dark/reload has one recorded visual check, not the full matrix. Stable1.5.2 release is authorized after exact packet and release gates; The Codex coordinator owns sequencing. Do not blindly finalize unrelated prereleases in parent3236.
...
User reports legacy navigation scrollbar on production Conduit Candidates. Direct visible IAB screenshot confirms native bright scrollbar track/arrows against dark navigation, plus native page scrollbar. This is a shared-theme ownership defect, not a missing import.

Read-only source/installed check: Conduit imports @bsuite/theme/css1.5.1; distributed CSS equals current shared source. Shared theme/nav/UI have no scrollbar or CSS color-scheme contract. All six consumers use1.5.1; CRM7 and BSU have divergent local scrollbar rules, four other apps have none. Local DashboardShell overflow-y-auto is reused desktop/mobile; shared UI AppShell content also scrolls.

Acceptance: define brand-neutral, semantic-role-bound shared scrollbar styling for both D2C and Corporate entry points; consolidate duplicate consumer styling without losing intended behavior; publish and pin all six consumers through signed development PRs and deployed verification. Preserve keyboard/wheel/touch scroll, sufficient contrast and user forced-color/accessibility behavior. Verify navigation expanded/collapsed/mobile, page content, light/dark/system, both brands, and overflow boundaries. Do not hide scrollbars to conceal the issue. Capture actual visible browser evidence at deployed SHA.

Part of existing whole-page visual/D8 remediation. Owner Codex task01a0858d-882e-7241-8a54-43adc8ee0b35; ui_touched=true; statusIN-PROGRESS. User screenshot observed2026-09-09 ~10:21Z.
