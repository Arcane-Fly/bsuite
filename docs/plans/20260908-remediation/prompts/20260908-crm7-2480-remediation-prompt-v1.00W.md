...
# Kick off crm7#2480: [D-144] Charge a nominal price for messaging customisation; support message tagging and merge fields

Implement and verify https://github.com/GaryOcean428/crm7/issues/2480. This is one bounded issue, not a launch of the whole backlog. Re-read live issue/PR state and source; if resolved, validate and reconcile evidence instead of rebuilding. Act after reading; do not stop at a plan or ask again whether to continue.
...
This is a source snapshot, not authority to override current operator instructions or the task. Validate old paths/claims. Live issue: https://github.com/GaryOcean428/crm7/issues/2480.

---

**Operator's words** (`~/Downloads/bsuite notes (7).docx`, register row D-144, route/surface: messaging setup / plan chooser; message):

> this is a business so some customization will take time for me and provides value so for now so we have it build in a nominal proce to do this. also consider tagging of m

**The ask:** Charge a nominal price for messaging customisation; support message tagging and merge fields
...
Ruling of record: qig-memory `bsuite_operator_ruling_20260906_agents_own_visual_validation`. Register: `docs/20260825-operator-notes-register-d1-d103-v1.00W.md` row D-144.
