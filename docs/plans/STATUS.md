...
| UI/UX/a11y/perf | Suite-wide UI/perf work remains in bsuite #475/#476/#478/#479/#483/#484 and app-specific issues such as CRM7 #881/#833 and throughput #184. The focused Throughput token slice merged via throughput#204, replacing raw palette utilities on Page, Export, BlobDemo, SupabaseSetup, and ResearchPanel with semantic theme tokens. | Continue Task 8 with remaining cross-app component inventory, accessibility/performance/theme sweeps, and screenshot evidence. |
