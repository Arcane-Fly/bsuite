...
| UI/UX/a11y/perf | Suite-wide UI/perf work remains in bsuite #475/#476/#478/#479/#483/#484 and app-specific issues such as CRM7 #881/#833. Throughput #184 is closed: throughput#204 fixed the focused dark-mode card surfaces and throughput#205 completed the remaining raw Tailwind palette sweep with semantic D2C tokens. | Continue Task 8 with remaining cross-app component inventory, accessibility/performance/theme sweeps, and screenshot evidence. |
