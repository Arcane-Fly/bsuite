...
| UI/UX/a11y/perf | Suite-wide UI/perf work remains in bsuite #475/#476/#478/#479/#483/#484 and CRM7 #833. Throughput #184 is closed: throughput#204 fixed the focused dark-mode card surfaces and throughput#205 completed the remaining raw Tailwind palette sweep with semantic D2C tokens. CRM7 #881 is closed by CRM7#1012-#1016: TS/TSX raw-palette classes scan at 0 and true six/eight-digit color hex outside token/theme/palette files scan at 0, with `pdfOklch()` preserving OKLCH source values for React-PDF compatibility. PWA slices for bsuite#484 are progressing: R80.3 manifest/apple-touch-icon merged via R80.3#305; BSU icon-set/OKLCH manifest merged via BSU#536; Throughput manifest/icon set merged via throughput#206; Braden corporate manifest/icon set merged via braden#317. | Continue Task 8 with remaining cross-app component inventory, accessibility/performance/theme sweeps, and screenshot evidence. |
