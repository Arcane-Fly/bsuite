...
| 7 | Continue bsuite#570 after the adapter/credential/settings slices — crm7#988 merged MYOB/Astute export adapters, crm7#989 merged Vault-backed provider credential storage plus Astute DB provider support, and crm7#990 surfaced those credentials in Settings; remaining work is STP path resolution against ADR 0004 and EOFY finalisation flow. | CRM7 implementer |
